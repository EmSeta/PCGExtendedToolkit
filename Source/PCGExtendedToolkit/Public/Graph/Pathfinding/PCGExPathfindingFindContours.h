...
namespace PCGExFindContours
{
	...
	public:
		...
		/** [EmSeta]
		Created Public Getter Methods to avoid member access warnings/errors in clang */
		...
		FRWLock& GetUniquePathsLock() const { return UniquePathsLock; }
		TSet<uint64>& GetUniquePathsStartPairs() { return UniquePathsStartPairs; }
		TSet<uint32>& GetUniquePathsBounds() { return UniquePathsBounds; }
		PCGExMT::FTaskManager* GetAsyncManagerPtr() const { return AsyncManagerPtr; }
